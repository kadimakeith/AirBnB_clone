...
class TestHBNBCommand_create(unittest.TestCase):
    ...
    def test_create_object(self):
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testKey = f"BaseModel.{output.getvalue().strip()}"
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertLess(0, len(output.getvalue().strip()))
            testKey = f"User.{output.getvalue().strip()}"
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
            self.assertLess(0, len(output.getvalue().strip()))
            testKey = f"State.{output.getvalue().strip()}"
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
            self.assertLess(0, len(output.getvalue().strip()))
            testKey = f"City.{output.getvalue().strip()}"
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            self.assertLess(0, len(output.getvalue().strip()))
            testKey = f"Amenity.{output.getvalue().strip()}"
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
            self.assertLess(0, len(output.getvalue().strip()))
            testKey = f"Place.{output.getvalue().strip()}"
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
            self.assertLess(0, len(output.getvalue().strip()))
            testKey = f"Review.{output.getvalue().strip()}"
            self.assertIn(testKey, storage.all().keys())
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            command = f"show BaseModel {testID}"
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()[f"State.{testID}"]
            command = f"show State {testID}"
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()[f"Amenity.{testID}"]
            command = f"show Amenity {testID}"
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()[f"Review.{testID}"]
            command = f"show Review {testID}"
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
    ...
    def test_show_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()[f"BaseModel.{testID}"]
            command = f"BaseModel.show({testID})"
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    def test_destroy_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()[f"BaseModel.{testID}"]
            command = f"destroy BaseModel {testID}"
            self.assertFalse(HBNBCommand().onecmd(command))
    ...
    def test_destroy_objects_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()[f"BaseModel.{testID}"]
            command = f"BaseModel.destroy({testID})"
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()[f"State.{testID}"]
            command = f"State.destroy({testID})"
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()[f"Amenity.{testID}"]
            command = f"Amenity.destroy({testID})"
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()[f"Review.{testID}"]
            command = f"Review.destory({testID})"
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_attr_name_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
            testCmd = f"update BaseModel {testId}"
        with patch("sys.stdout", new=StringIO()) as output:
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            testId = output.getvalue().strip()
            testCmd = f"update Amenity {testId}"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_attr_name_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            testId = output.getvalue().strip()
            testCmd = f"Amenity.update({testId})"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_attr_value_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"update BaseModel {testId} attr_name"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"update User {testId} attr_name"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"update State {testId} attr_name"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"update City {testId} attr_name"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"update Amenity {testId} attr_name"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"update Place {testId} attr_name"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"update Review {testId} attr_name"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
    ...
    def test_update_missing_attr_value_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"BaseModel.update({testId}, attr_name)"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"User.update({testId}, attr_name)"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"State.update({testId}, attr_name)"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create City")
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"City.update({testId}, attr_name)"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Amenity")
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"Amenity.update({testId}, attr_name)"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"Place.update({testId}, attr_name)"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = f"Review.update({testId}, attr_name)"
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
    ...
    def test_update_valid_string_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = f"update BaseModel {testId} attr_name 'attr_value'"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"BaseModel.{testId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
            testId = output.getvalue().strip()
        testCmd = f"update User {testId} attr_name 'attr_value'"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"User.{testId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
            testId = output.getvalue().strip()
        testCmd = f"update State {testId} attr_name 'attr_value'"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"State.{testId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create City")
            testId = output.getvalue().strip()
        testCmd = f"update City {testId} attr_name 'attr_value'"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"City.{testId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = f"update Place {testId} attr_name 'attr_value'"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Amenity")
            testId = output.getvalue().strip()
        testCmd = f"update Amenity {testId} attr_name 'attr_value'"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"Amenity.{testId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
            testId = output.getvalue().strip()
        testCmd = f"update Review {testId} attr_name 'attr_value'"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"Review.{testId}"].__dict__
    ...
    def test_update_valid_string_attr_dot_notation(self):
        ...
        testCmd = f"BaseModel.update({tId}, attr_name, 'attr_value')"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"BaseModel.{tId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
            tId = output.getvalue().strip()
        testCmd = f"User.update({tId}, attr_name, 'attr_value')"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"User.{tId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
            tId = output.getvalue().strip()
        testCmd = f"State.update({tId}, attr_name, 'attr_value')"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create City")
            tId = output.getvalue().strip()
        testCmd = f"City.update({tId}, attr_name, 'attr_value')"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"City.{tId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
        testCmd = f"Place.update({tId}, attr_name, 'attr_value')"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Amenity")
            tId = output.getvalue().strip()
        testCmd = f"Amenity.update({tId}, attr_name, 'attr_value')"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"Amenity.{tId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
            tId = output.getvalue().strip()
        testCmd = f"Review.update({tId}, attr_name, 'attr_value')"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"Review.{tId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])
    ...
    def test_update_valid_int_attr_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
        testCmd = f"Place.update({tId}, max_guest, 98)"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"Place.{tId}"].__dict__
        self.assertEqual(98, test_dict["max_guest"])
    ...
    def test_update_valid_float_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = f"update Place {testId} latitude 7.2"
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()[f"Place.{testId}"].__dict__
    ...
    def test_update_valid_dictionary_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        testCmd = (
            f"update BaseModel {testId} " + "{'attr_name': 'attr_value'}"
        )
    ...
    def test_update_valid_dictionary_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        testCmd = (
            f"BaseModel.update({testId}" + "{'attr_name': 'attr_value'})"
        )
        HBNBCommand().onecmd(testCmd)
        test_dict = storage.all()[f"BaseModel.{testId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
            testId = output.getvalue().strip()
        testCmd = f"User.update({testId}, " + "{'attr_name': 'attr_value'})"
        HBNBCommand().onecmd(testCmd)
        test_dict = storage.all()[f"User.{testId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        testCmd = (
            f"Amenity.update({testId}, " + "{'attr_name': 'attr_value'})"
        )
        HBNBCommand().onecmd(testCmd)
        test_dict = storage.all()[f"Amenity.{testId}"].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])
    ...
    def test_update_valid_dictionary_with_int_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = f"Place.update({testId}, " + "{'max_guest': 98})"
        HBNBCommand().onecmd(testCmd)
        test_dict = storage.all()[f"Place.{testId}"].__dict__
        self.assertEqual(98, test_dict["max_guest"])
    ...
    def test_update_valid_dictionary_with_float_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = f"update Place {testId} " + "{'latitude': 9.8})"
        HBNBCommand().onecmd(testCmd)
        test_dict = storage.all()[f"Place.{testId}"].__dict__
    ...
    def test_update_valid_dictionary_with_float_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = f"Place.update({testId}, " + "{'latitude': 9.8})"
        HBNBCommand().onecmd(testCmd)
        test_dict = storage.all()[f"Place.{testId}"].__dict__
        self.assertEqual(9.8, test_dict["latitude"])
